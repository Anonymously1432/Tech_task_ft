...
INSERT INTO users (email, password_hash, full_name, phone, birth_date, address, role, is_active, created_at, updated_at) VALUES
                                                                                                                             ...
                                                                                                                             -- Менеджеры
                                                                                                                             ('manager1@test.com', '$2a$15$SezWJOiCJZthHr4ppMXil.c5A2BHerQPgRDsrOZFgkIszqmhZuY6i', 'Менеджер Мария Ивановна', '+79007778899', '1988-07-18', NULL, 'manager', true, NOW(), NOW()),
                                                                                                                             ('manager2@test.com', '$2a$15$SezWJOiCJZthHr4ppMXil.c5A2BHerQPgRDsrOZFgkIszqmhZuY6i', 'Менеджер Пётр Николаевич', '+79006665544', '1992-11-25', NULL, 'manager', true, NOW(), NOW()),
